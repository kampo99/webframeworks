...
@Component({
  ...
  templateUrl: './detail35.component.html',
  styleUrls: ['./detail35.component.css']
})
export class Detail35Component implements OnInit, OnChanges{

  inputScooter: Scooter;
  backup: Scooter;


  constructor(private scooterService: ScooterSbService, private route: ActivatedRoute, private router: Router) {
  }
